...
Public Class po_report
    ...
    Private Sub Cmd_View_Click(sender As Object, e As EventArgs) Handles Cmd_View.Click
        Try
            ...
            Dim r As New Cry_POREPORT
            sqlstring = " SELECT * FROM VIEW_PO_REPORT WHERE PODATE "
    ...
    Private Sub po_report_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub po_report_Load(sender As Object, e As EventArgs) Handles MyBase.Load
