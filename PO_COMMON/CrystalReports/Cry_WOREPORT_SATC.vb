...
Public Class Cry_WOREPORT_SATC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Cry_WOREPORT_SATC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_WOREPORT_SATC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_WOREPORT_SATC = New Cry_WOREPORT_SATC()
        rpt.Site = Me.Site
        Return rpt
    End Function
