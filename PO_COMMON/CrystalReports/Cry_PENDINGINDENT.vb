...
Public Class Cry_PENDINGINDENT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Cry_PENDINGINDENT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_PENDINGINDENT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_PENDINGINDENT = New Cry_PENDINGINDENT()
        rpt.Site = Me.Site
        Return rpt
    End Function
