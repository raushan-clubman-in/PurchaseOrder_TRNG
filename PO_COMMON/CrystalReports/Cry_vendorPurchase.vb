...
Public Class Cry_vendorPurchase
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Cry_vendorPurchase.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_vendorPurchase
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_vendorPurchase = New Cry_vendorPurchase()
        rpt.Site = Me.Site
        Return rpt
    End Function
