...
Public Class Cry_CAT_PORPT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Cry_CAT_PORPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_CAT_PORPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_CAT_PORPT = New Cry_CAT_PORPT()
        rpt.Site = Me.Site
        Return rpt
    End Function
