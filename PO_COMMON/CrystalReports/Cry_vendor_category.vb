...
Public Class Cry_vendor_category
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Cry_vendor_category.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Cry_vendor_category.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_vendor_category
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_vendor_category = New Cry_vendor_category()
        rpt.Site = Me.Site
        Return rpt
    End Function
