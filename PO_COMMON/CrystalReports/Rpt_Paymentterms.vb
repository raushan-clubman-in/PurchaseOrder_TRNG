...
Public Class Rpt_Paymentterms
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Rpt_Paymentterms.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Paymentterms
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Paymentterms = New Rpt_Paymentterms()
        rpt.Site = Me.Site
        Return rpt
    End Function
