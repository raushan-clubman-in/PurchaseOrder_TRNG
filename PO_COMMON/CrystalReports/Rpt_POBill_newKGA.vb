...
Public Class Rpt_POBill_newKGA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Rpt_POBill_newKGA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_POBill_newKGA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_POBill_newKGA = New Rpt_POBill_newKGA()
        rpt.Site = Me.Site
        Return rpt
    End Function
