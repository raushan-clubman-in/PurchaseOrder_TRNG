...
Public Class Cry_ho_report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Cry_ho_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_ho_report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_ho_report = New Cry_ho_report()
        rpt.Site = Me.Site
        Return rpt
    End Function
