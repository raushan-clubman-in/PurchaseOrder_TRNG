...
Public Class Rpt_WOBBill3_SATC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Rpt_WOBBill3_SATC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_WOBBill3_SATC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_WOBBill3_SATC = New Rpt_WOBBill3_SATC()
        rpt.Site = Me.Site
        Return rpt
    End Function
