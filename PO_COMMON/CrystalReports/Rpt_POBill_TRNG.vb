...
Public Class Rpt_POBill_TRNG
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Rpt_POBill_TRNG.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_POBill_TRNG
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_POBill_TRNG = New Rpt_POBill_TRNG()
        rpt.Site = Me.Site
        Return rpt
    End Function
