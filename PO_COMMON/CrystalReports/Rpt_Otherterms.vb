...
Public Class Rpt_Otherterms
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Rpt_Otherterms.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Otherterms
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Otherterms = New Rpt_Otherterms()
        rpt.Site = Me.Site
        Return rpt
    End Function
