...
Public Class Rpt_Vendormaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Rpt_Vendormaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Vendormaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Vendormaster = New Rpt_Vendormaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
