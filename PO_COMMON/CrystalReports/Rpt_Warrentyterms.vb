...
Public Class Rpt_Warrentyterms
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Rpt_Warrentyterms.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Warrentyterms
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Warrentyterms = New Rpt_Warrentyterms()
        rpt.Site = Me.Site
        Return rpt
    End Function
