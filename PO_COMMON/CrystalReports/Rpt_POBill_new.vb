...
Public Class Rpt_POBill_new
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Rpt_POBill_new.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_POBill_new
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_POBill_new = New Rpt_POBill_new()
        rpt.Site = Me.Site
        Return rpt
    End Function
