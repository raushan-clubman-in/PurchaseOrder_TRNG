...
Public Class Cry_PENDINGITEMGRN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartCard.Cry_PENDINGITEMGRN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCry_PENDINGITEMGRN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cry_PENDINGITEMGRN = New Cry_PENDINGITEMGRN()
        rpt.Site = Me.Site
        Return rpt
    End Function
